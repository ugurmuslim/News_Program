    ...
    <div class="header__middle">
        <div class="container nav__contanier--desktop">
            <div class="nav__list">
                <ul class="nav nav-pills main_menu_ul">
                    <li><a href="#">HİSSE ÖNERİLERİ</a></li>
                ...
                <div class="toggle_menu_icon_div">
                    <button id="large-nav-menu-button" class="menu__button" onclick="toggleLargeNavMenu(event)">
                        <svg id="menu_icon_rigth" xmlns="http://www.w3.org/2000/svg" style="width: 44px; height: 44px; padding: 5px; pointer-events: none;" fill="none" viewBox="0 0 24 24" stroke="black">
        ...
        <div class="container nav__contanier--mobile">
            <button id="drawer-nav-button" class="menu__button">
                <svg xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px; pointer-events: none;" fill="none" viewBox="0 0 24 24" stroke="black">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
                </svg>
            </button>
            ...
            <svg id="mobile_search_icon2" xmlns="http://www.w3.org/2000/svg" style="width: 24; height: 24;" fill="none" viewBox="0 0 24 24" stroke="black">
        ...
        <div class="container">
            <div class="header__bottom">
                ...
                <div id="mobile_search_input2_div">
                    <input id="mobile_search_input2" class="search__input" type="text" placeholder="Parafesör'de Ara...">
