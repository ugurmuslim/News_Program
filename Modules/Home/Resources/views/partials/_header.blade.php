    ...
    <div class="header__middle">
            ...
            <div class="nav__list">
                ...
                <div class="toggle_menu_icon_div">
                    <button id="large-nav-menu-button" class="menu__button" onclick="toggleLargeNavMenu(event)">
                        <svg xmlns="http://www.w3.org/2000/svg" style="width: 44px; height: 44px; padding: 5px; pointer-events: none;" fill="none" viewBox="0 0 24 24" stroke="black">
        ...
        <div class="container nav__contanier--mobile">
            ...
            <div id="drawer-nav" class="drawer__navigation" style="display: none;">
                <div style="display: flex; justify-content: flex-end; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; background-color: #242424">
                    <button style="outline: none; border: none; background-color: transparent;" onclick="toggleDrawerNav(event)">
