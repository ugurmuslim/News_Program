<section id="section-egitim">
    <div class="container">
        ...
        <div class=" d-sm-block d-md-none section-right-sm text-blue-alternative"><a href="https://parafesor.net/kategori/egitim">Tüm Eğitim Haberlerini Gör</a></div>
    </div>
    </div>
    <div class="container">
                ...
                <a href="{{route('article.show',['slug' => $article->slug ])}}">
                    <div class="col-24 ">
                        <div class="col-sm-24 h-100">
                            <div class="col-24 education education-md lazy" style="background-image: url({{asset($article->image_path)}})"></div>
