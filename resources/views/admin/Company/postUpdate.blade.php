...
@section('content')
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form id="form" method="post" data-parsley-validate
                          action={{route('system.company.store')}} enctype="multipart/form-data">
                        @csrf
                        <div class="row row-sm">
                            <input type="text" value="Normal" name="PlacementSection" id="PlacementSection"
                                   hidden>
                            <input name="ArticleTypeId" type="number" class="form-control"
                                   id="category"
                                   value="{{\App\Parafesor\Constants\ArticleTypes::SirketHaberleri}}"
                                   maxlength="200" autocomplete="off" hidden/>


                            <input name="CompanyId" type="number" class="form-control"
                                   placeholder="Lorem ipsum dolor"
                                   value="{{isset($company) ? $company->id : null}}"
                                   maxlength="200" autocomplete="off" hidden/>
                            ...
                            <div class="col-md-9 row align-content-start">
                                <div class="col-10">
                                    ...
                                    <input name="Title" type="text" class="form-control"
                                           ...
                                           id="companyTitle"
                                           value="{{isset($company) ? $company->title : ""}}"
    ...
    --}}                                    {{--<input type="file" name="select_file" id="articleImage">--}}
                                        <input type="file" name="image"
                                               class="image" {{isset($company) && $company->image_path ? "" : "required"}}>
