...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{asset("assets/home/sample/css/bootstrap.css")}}" rel="stylesheet">
    <link href="{{asset("assets/home/sample/css/main.css")}}" rel="stylesheet">
    <link href="{{asset("assets/home/sample/css/color.css")}}" rel="stylesheet">
                        ...
                        <div class="row px-3">
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset("assets/home/sample/img/news/news1.jpg")}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset("assets/home/sample/img/news/news1.jpg")}})"></div>
        ...
        <div class="row ">
            ...
            <div class="col-md-8 mt-3">
                <div class="image-card image-card-16x8  image-card-bordered image-cover"
                     style="background-image: url({{asset("assets/home/sample/img/news/news1.jpg")}})">test
                </div>
            </div>
        </div>
            ...
            <div class="col-24 mt-5 mb-2 pt-3" id="most-red">
                ...
                <div
                    ...
                    <div class="channel-logo"
                         style="background-image: url({{asset("assets/home/sample/img/news/portrait1.jpg")}})"></div>
                    <div class="channel-logo"
                         style="background-image:url({{asset("assets/home/sample/img/news/portrait1.jpg")}})"></div>
                    <div class="channel-logo"
                         style="background-image:url({{asset("assets/home/sample/img/news/portrait1.jpg")}})"></div>
            ...
            <div class="col-12 col-lg-6 mt-3">
                <div class="card">
                    <div class="company-image"
                         style="background-image: url({{asset("assets/home/sample/img/news/migros.png")}})"></div>
