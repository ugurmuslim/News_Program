                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-2">
                        <div class="card news-card news-card-big ">
                            <div class="news-card-img-container bg-light-grey">
                                <div style="background: url({{asset('assets/home/sample/img/news/s1n1.webp')}})" alt="" class="news-img"></div>
                            ...
                            <div class="news-card-slider-container">
                                <div class="news-card-slider-slide">
                                    ...
                                    <div class="news-card-slider-slide-img "
                                         style="background-image: url({{asset('assets/home/sample/img/news/s1s1p1.jpg')}})">
                                ...
                                <div class="news-card-slider-slide">
                                    ...
                                    <div class="news-card-slider-slide-img "
                                         style="background-image: url(asset('assets/home/sample/img/news/s1n2.jpg')">
                                ...
                                <div class="news-card-slider-slide">
                                    ...
                                    <div class="news-card-slider-slide-img "
                                         style="background-image: url({{asset('assets/home/sample/img/news/s1n5.jpg')}})">
                    ...
                    <div class="col-lg-6 col-sm-12 mt-5">
                        <div class="card news-card news-card-small ">
                            <div class="news-card-img-container bg-light-grey">
                                <div style="background: url({{asset('assets/home/sample/img/news/s1n5.jpg')}})" alt="" class="news-img"></div>
                    ...
                    <div class="col-lg-6 col-sm-12 mt-5">
                        <div class="card news-card news-card-small ">
                            <div class="news-card-img-container bg-light-grey">
                                <div style="background: url({{asset('assets/home/sample/img/news/s1n3.jpg')}})" alt="" class="news-img"></div>
            ...
            <div class="col-lg-14">
                <div class="ratio ratio-16x9 mt-2" id="borsaEmbed">
                    <div class="image-card image-card-bw-16x10"
                         style="background-image: url({{asset('assets/home/sample/img/news1/tv/a.png')}})"></div>
                ...
                <div class="text-danger" style=" height:100%; overflow: hidden">
                    <div matchTo="borsaEmbed" class="match"
                        ...
                        <div class="row px-3">
                            ...
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/b.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/c.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/d.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/e.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/f.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/h.png')}})"></div>
                            </div>
                            <div class="image-card-container">
                                <div class="image-card image-card-bw-16x10"
                                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/i.png')}})"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row ">
            <div class="col-md-8 mt-3">
                <div class="image-card image-card-16x8 image-cover image-card-bordered"
                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/i.png')}})">test
                </div>
            </div>
            <div class="col-md-8 mt-3">
                <div class="image-card image-card-16x8 image-cover image-card-bordered"
                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/ab.png')}})">test
                </div>
            </div>
            <div class="col-md-8 mt-3">
                <div class="image-card image-card-16x8  image-card-bordered image-cover"
                     style="background-image: url({{asset('assets/home/sample/img/news1/tv/ac.png')}})">test
                </div>
            </div>
        </div>
        <div class="row mt-5 text-white">
            ...
            <div class="col-24 mt-5 mb-2 pt-3" id="most-red">
                ...
                <div style="float:left; overflow-y: hidden; overflow-x: auto; text-align:center; width: calc(100% - 60px);margin-top:-25px; padding-bottom:10px; white-space: nowrap">
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news/portrait1.jpg')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-hbrglobal-Ab.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-apara-01.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-apara-A.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-blomberg-Ab.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-cnn-01.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/logo-ekoturk-Ab.png')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/y-kanal-1.jpg')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/y-kanal-1.jpg')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/y-kanal-3.jpg')}})"></div>
                    <div class="channel-logo" style="background-image: url({{asset('assets/home/sample/img/news1/tv/y-kanal-4.jpg')}})"></div>
                </div>
            ...
            <div class="col-12 col-lg-6 mb-3">
                <div class="card tweet-card tweet-card-small bg-white">
                    <div class="tweet-top">
                        <div class="tweet-user">
                            <div class="float-start">
                                <img class="image-twitter" src="{{asset('assets/home/sample/img/news/s1n2.jpg')}}">
                            </div>
...
<section id="section-sirket-haberleri">
    <div class="container">
            ...
            <div class="col-xl-13 mb-5">
                <div class="card news-card news-card-big ">
                    <div class="news-card-img-container bg-white">
                        <div style="background-image: url({{asset('assets/home/sample/img/news/s1n1.webp')}})" alt="" class="news-img"></div>
        ...
        <div class="row">
            ...
            <div class="col-24 col-md-12 col-lg-6 mt-3">
                <div class="card">
                    <div class="company-image" style="background-image: url({{asset('assets/home/sample/img/news/migros.png')}})"></div>
                    <div class="company-text">
                        Şirketin net karı 2020 yılı genelinde ise yıllık yüzde 58 artışla 29.2 milyar dolara çıktı.
                        Haberin devam metni gelecek kısımlarda. 2021 haberleri Migros tanıtım sayfası...
                    </div>
            ...
            <div class="col-24 col-md-12 col-lg-6 mt-3">
                <div class="card">
                    <div class="company-image" style="background-image: url({{asset('assets/home/sample/img/news1/sirket-logolar/-Ihalesinin-1-Oturumun-9-Martta-Yaplaca-Akland-468204.jpg')}})"></div>
                    <div class="company-text">
                        Şirketin net karı 2020 yılı genelinde ise yıllık yüzde 58 artışla 29.2 milyar dolara çıktı.
                        Haberin devam metni gelecek kısımlarda. 2021 haberleri Migros tanıtım sayfası...
                    </div>
                        ...
                        <a href="{{$article->original_link}}" class="non-decoration">
                            <div class="row">
                                ...
                                <div class="article-text">
                                    ...
                                    <div class="article-logo-bottom" ><img src="{{asset('assets/home/sample/img/newspaper-logos/sozcu.svg')}}" alt="" style="background-color: red" width="80px;"></div>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-24 col-md-12 col-lg-6 mt-3">
                ...
                <div class="most-red">
                    <div class="most-red-image" style="background-image: url({{asset('assets/home/sample/img/news1/grammy-odulleri.png')}})"></div>
                    <div class="most-red-text">
            ...
            <div class="col-sm-24 col-md-12 col-lg-6 mt-3">
                ...
                <div class="most-red">
                    <div class="most-red-image" style="background-image: url({{asset('assets/home/sample/img/news/s1n1.webp')}})"></div>
                    <div class="most-red-text">
        ...
        <div class="row pb-5">
            ...
            <div class="col-md-19">
                    ...
                    <div class="col-lg-18 col-md-24 mt-1 match" matchTo="tech-second-row-anchor">
                        <div class="card news-card news-card-big cardSlider" currentSlide="0">
                            ...
                            <div class="news-card-slider-container">
                                ...
                                <div class="news-card-slider-slide">
                                    <div class="tech-card-slider-slide-img text-white"
                                         style="background-image: url({{asset('assets/home/sample/img/news/s1n3.jpg')}})">
                ...
                <div class="row mb-4 mt-2">
                    ...
                    <div class="col-sm-24 col-md-12 col-lg-8 mt-3">
                        <div class="col-24 tech tech-md" style="background-image: url({{asset('assets/home/sample/img/news/sliderNext.webp')}})"></div>
                        <div class="tech-title">Maliye Bakanlığı'ndan Kılıçdaroglu'na yanıt: Aradaki ayrımı bilmiyor
                            <div class="tech-text-bottom-sm">
                                <span class="text-purple">23 Ocak</span><span> • 14:35 • parafesor</span>
                            </div>
            ...
            <div class="col-md-14 mt-3">
                <div class="card news-card news-card-big keep-ratio cardSlider" currentSlide="0" ratio="0.5"
                    ...
                    <div class="news-card-slider-container">
                        ...
                        <div class="news-card-slider-slide">
                            <div class="life-card-slider-slide-img "
                                 style="background-image: url(({{asset('assets/home/sample/img/news1/pexels-photo-2817318.jpg')}}))">
  ...
  {{--      <div class="row mt-3">
        ...
        <div class="row mb-4 mt-2">
            ...
            <div class="col-sm-24 col-md-12 col-lg-6 mt-3 h-100">
                <div class="col-24 life life-md" style="background-image: url({{asset('assets/home/sample/img/news/sliderNext.webp')}})"></div>
                <div class="life-title">Maliye Bakanlığı'ndan Kılıçdaroglu'na yanıt: Aradaki ayrımı bilmiyor
                    <div class="life-text-bottom-sm">
                        <span class="text-orange">23 Ocak</span><span> • 14:35 • parafesor</span>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-md-24 col-lg-12 p-4 ">
                <div class="row">
                    <div class="col-10" style="background-image: url({{asset('assets/home/sample/img/news/sliderNext.webp')}})"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mt-4">
                        <div class="col-24">
                            <div class="col-sm-24 ">
                                <div class="col-24 internet internet-md"
                                     style="background-image: url({{asset('assets/home/sample/img/news/sliderNext.webp')}})"></div>
                                <div class="internet-title">
                                    <div class="multilineEllipsis" multilineEllipsisMax="100">Maliye Bakanlığı'ndan
                                        KMaliye Bakanlığı'ndan KMaliye Bakanlığı'ndan KMaliye Bakanlığı'ndan KMaliye
                                        Bakanlığı'ndan KMaliye Bakanlığı'ndan KMaliye Bakanlığı'ndan KMaliye
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                ...
                {{--<div class="col-xl-13 mb-5">
                    <div class="card news-card news-card-big ">
                        <div class="news-card-img-container bg-white">
                            <div style="background-image: url({{asset("assets/home/sample/img/news/s1n1.webp")}})" alt=""
                                 class="news-img"></div>
                            <div class="news-card-img-text text-dark-blue">Polat Enerji'nin Tamamının Satışı İçin
                                Ortaklar Barclays'i Yetkilendirdi
                            </div>
