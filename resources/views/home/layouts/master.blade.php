...
<head>
    ...
    <link href="{{ asset('assets/home/sample/css/main.css') }}?v=15" rel="stylesheet" type="text/css"/>
    {{-- Header Resources - Start --}}
    <link href="{{ asset('assets/home/sample/css/header.css') }}" rel="stylesheet" type="text/css"/>
    {{-- Header Resources - End --}}
    <link href="{{ asset('assets/home/sample/css/topSlider.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/articles.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/corporate.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/share-recommendation.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/tweets.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/tube.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/most-red.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/last-min.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/sport.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/life.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/tech.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/automobile.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/crypto.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/internet.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/education.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/common.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/color.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/glide.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('assets/home/sample/css/footer.css') }}" rel="stylesheet" type="text/css"/>
    {{--    <link rel="stylesheet" href="{{ asset('assets/home/sample/css/font-awesome/all.min.css') }}"--}}
