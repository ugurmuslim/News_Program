        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-12 col-24">
                    <a href="#"><img src="{{asset('assets/home/sample/img/parafesor-logo-light.svg')}}" alt="Parafesör Light Logo"></a>
                    <p>Paranıza Akıl Verir<br>Gündemin en önemli haberleri Parafesör’de! Borsa, hisse, şirket, kripto, teknoloji ve yaşam haberleri.</p>
            ...
            <div class="row copyright">
                ...
                <div class="col-right col-lg-12 col-sm-24">
                    <a href="#"><img src="{{asset('assets/home/sample/img/anadolu-ajansi-logo.svg')}}" target="_blank" alt="Anadolu Ajansı Logo"></a>
                    <a href="#"><img src="{{asset('assets/home/sample/img/foreks-logo.svg')}}" target="_blank" alt="Foreks Logo"></a>
                </div>
            </div>
        </div>
    </footer>
