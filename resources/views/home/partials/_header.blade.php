<header>
    ...
    <div class="header__middle">
        <div class="container nav__contanier--desktop">
            <div class="nav__list">
                <a href="/"><img src="{{asset('assets/home/sample/img/logo-dark.svg')}}" alt="Parafesör Logo"
                                 height="76"></a>
        ...
        <div class="container nav__contanier--mobile">
            ...
            <a href="/" class="header__nav__logo">
                <img src="{{asset('assets/home/sample/img/logo-dark.svg')}}" alt="Header Logo" width="226" height="54">
            </a>
            ...
            <div class="container">
                <div class="header__bottom">
                    <div class="nav__text__container" id="nav__text__container">
                        <img style="flex: none;" src="{{asset('assets/home/sample/img/hepsi-parafesorde.png')}}" alt=""
                             width="175" height="55">
